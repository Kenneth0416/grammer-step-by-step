...
export const Chatbot = forwardRef<ChatbotHandle, ChatbotProps>(
  ({ lessonTitle, unitTitle, unitType, isQuiz, unitExamples }, ref) => {
    ...
    return (
      <>
        ...
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-academic-blue to-academic-blue-dark text-white p-4 rounded-t-2xl flex items-center justify-between flex-shrink-0">
